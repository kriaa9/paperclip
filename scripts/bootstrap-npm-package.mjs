...
function usage() {
  process.stderr.write(
    [
      ...
      "",
      "Examples:",
      "  node scripts/bootstrap-npm-package.mjs @jasminia/adapter-acpx-local",
  ...
  if (/\bE401\b|401 Unauthorized/i.test(output)) {
    throw new Error(
      [
        ...
        "Run `npm logout --registry=https://registry.npmjs.org/` and then `npm login` or `npm adduser` on this maintainer machine with an npm account that can publish to the @jasminia scope, then rerun with --publish.",
