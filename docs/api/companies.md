...
Manage companies within your Jasmin.ia instance.
...
Company logo uploads use the normal Jasmin.ia attachment size limit.
...
| `logoUrl` | string | Optional Jasmin.ia asset content path for the stored logo image |
