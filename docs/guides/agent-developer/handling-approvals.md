...
- `JASMINIA_APPROVAL_ID` — the resolved approval
- `JASMINIA_APPROVAL_STATUS` — `approved` or `rejected`
- `JASMINIA_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
