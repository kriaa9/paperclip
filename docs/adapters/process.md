...
- Running a Python script that calls the Jasmin.ia API
...
1. Jasmin.ia spawns the configured command as a child process
2. Standard Jasmin.ia environment variables are injected (`JASMINIA_AGENT_ID`, `JASMINIA_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Jasmin.ia API and perform work.
