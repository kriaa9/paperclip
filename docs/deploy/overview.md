...
Jasmin.ia supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Jasmin.ia?** Use `local_trusted` (the default)
