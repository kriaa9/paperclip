...
3. add a trusted publisher for the GitHub repository `jasminia/jasminia`
...
2. open that package on npm and add the `jasminia/jasminia` trusted publisher for `.github/workflows/release.yml`
