...
- installed adapter list for this Jasmin.ia instance
...
## 8. New Skill: `jasminia-create-agent`

Create new skill directory:

- `skills/jasminia-create-agent/SKILL.md`
- `skills/jasminia-create-agent/references/api-reference.md`
...
Also update `skills/jasminia/SKILL.md` to reference this skill for hiring workflows.
...
- `jasminia-create-agent` skill + docs updates
