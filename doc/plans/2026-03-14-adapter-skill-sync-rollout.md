...
This document defines the rollout plan for adapter-wide skill support in Jasmin.ia.
...
- Jasmin.ia stores desired skill state consistently even when the adapter cannot fully reconcile it
- unsupported adapters degrade clearly and safely

## 2. Current Adapter Matrix

Jasmin.ia currently has these adapters:
...
1. Desired skills live in Jasmin.ia for every adapter.
...
These adapters have a stable local skills directory that Jasmin.ia can read and manage.
...
These adapters do not have a meaningful Jasmin.ia-owned persistent install state.
...
- desired skills stored in Jasmin.ia
...
- runtime already injects Jasmin.ia skills into `~/.cursor/skills`
...
- runtime already injects Jasmin.ia skills into `~/.gemini/skills`
...
- runtime already injects Jasmin.ia skills into `~/.pi/agent/skills`
...
- Jasmin.ia can sync desired skills into Pi’s persistent home
...
- OpenCode currently injects Jasmin.ia skills into `~/.claude/skills`

This is product-risky because:

- it shares state with Claude
- Jasmin.ia may accidentally imply the skills belong only to OpenCode when the home is shared
...
- only remove stale managed Jasmin.ia skills that are clearly marked as Jasmin.ia-managed
...
- Jasmin.ia stores desired skills only
...
- avoid destructive wording unless Jasmin.ia can prove a skill is Jasmin.ia-managed
...
That gets Jasmin.ia from “skills work for Codex and Claude” to “skills work for the whole local-adapter family,” which is the meaningful V1 milestone.
