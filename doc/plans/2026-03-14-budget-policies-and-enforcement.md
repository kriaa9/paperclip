...
Jasmin.ia already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Jasmin.ia should implement next.

## Product Goals

Jasmin.ia should let operators:
...
For the next implementation pass, Jasmin.ia should enforce these defaults:
...
Jasmin.ia should separate subscription-included usage from billed spend:
...
Jasmin.ia should have two threshold classes:
...
Jasmin.ia must know that a project is budget-paused and enforce it.
...
Jasmin.ia must also block execution before new work starts.
