...
- `skills/jasminia/SKILL.md` and `skills/jasminia/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/jasminia-create-agent/SKILL.md`
