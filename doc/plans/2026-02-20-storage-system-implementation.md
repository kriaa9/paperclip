...
Add a single storage subsystem for Jasmin.ia that supports:
...
- API serves attachment bytes through authenticated Jasmin.ia endpoints.
...
- Default local path is under instance root: `~/.jasminia/instances/<instanceId>/data/storage`.
