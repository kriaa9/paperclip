...
This note inventories the Jasmin.ia issues that point to the same UX class of problem:
...
Pattern: Jasmin.ia already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."
