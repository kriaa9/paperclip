...
This is intentionally separate from the normal Jasmin.ia dev image.
...
## Preview the Jasmin.ia app from the PR
...
- Jasmin.ia's embedded PostgreSQL and local storage stay inside the container home volume via `JASMINIA_HOME=/home/reviewer/.jasminia-review`.
