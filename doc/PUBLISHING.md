...
Low-level reference for how Jasmin.ia packages are prepared and published to npm.
...
Jasmin.ia no longer uses release branches or Changesets for publishing.
...
Jasmin.ia uses calendar versions:
...
Jasmin.ia does not auto-publish every non-private workspace package anymore.
