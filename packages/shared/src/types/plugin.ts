...
/**
 * Declares a normal Jasmin.ia agent that a plugin can provision and later
...
export interface PluginManagedAgentDeclaration {
  ...
  /** Suggested Jasmin.ia runtime configuration. */
...
/**
 * Declares a normal Jasmin.ia project that a plugin can provision and later
 * resolve by stable key within each company.
 */
...
/**
 * Lower-bound semver requirement for the Jasmin.ia host.
 *
