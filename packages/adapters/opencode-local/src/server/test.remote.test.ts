...
const {
  ...
  return {
    ...
    prepareAdapterExecutionTargetRuntime: vi.fn(async () => ({
      ...
      runtimeRootDir: "/remote/workspace/.jasminia-runtime/runs/test/workspace/.jasminia-runtime/opencode",
      assetDirs: {
        xdgConfig: "/remote/workspace/.jasminia-runtime/runs/test/workspace/.jasminia-runtime/opencode/xdgConfig",
      },
      restoreWorkspace,
    })),
  };
...
describe("opencode remote environment diagnostics", () => {
  ...
  it("stages remote runtime config assets for sandbox hello probes", async () => {
    ...
    const probeCall = runAdapterExecutionTargetProcess.mock.calls[0] as unknown as
      ...
      | undefined;
    expect(probeCall?.[4].cwd).toBe("/remote/workspace/.jasminia-runtime/runs/test/workspace");
    expect(probeCall?.[4].env.XDG_CONFIG_HOME).toBe(
      "/remote/workspace/.jasminia-runtime/runs/test/workspace/.jasminia-runtime/opencode/xdgConfig",
    );
  });
});
