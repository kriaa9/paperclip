...
## Scope
This plan is now **gateway-only**. Jasmin.ia supports OpenClaw through `openclaw_gateway` only.
...
3. In `/new` OpenClaw session, OpenClaw can still create a Jasmin.ia task.
