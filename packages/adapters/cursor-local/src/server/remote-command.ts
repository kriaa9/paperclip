...
import { ensurePathInEnv } from "@jasminiaai/adapter-utils/server-utils";
...
async function readSandboxCursorRuntimeInfo(input: {
  ...
  const homeMarker = "__JASMINIA_CURSOR_HOME__:";
  const preferredMarker = "__JASMINIA_CURSOR_AGENT__:";
  try {
