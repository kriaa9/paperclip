...
export const feedbackExports = pgTable(
  "feedback_exports",
  {
    ...
    schemaVersion: text("schema_version").notNull().default("jasminia-feedback-envelope-v2"),
    bundleVersion: text("bundle_version").notNull().default("jasminia-feedback-bundle-v2"),
    payloadVersion: text("payload_version").notNull().default("jasminia-feedback-v1"),
