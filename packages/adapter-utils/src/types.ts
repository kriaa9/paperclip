...
export interface AdapterEnvironmentTestContext {
   ...
   *
   * If omitted (or `kind === "local"`), the adapter tests on the Jasmin.ia
...
export interface AdapterRuntimeCommandSpec {
  /**
   * The command Jasmin.ia should execute for this adapter in the current config.
   */
  command: string;
  /**
...
export interface ServerAdapterModule {
   ...
   * rather than reading config.jasminiaRuntimeSkills.
   */
