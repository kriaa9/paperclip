...
export async function handleBridgeRequest(request: Request, env: BridgeEnv): Promise<Response> {
  ...
  if (request.method === "GET" && pathname === "/api/jasminia-sandbox/v1/health") {
  ...
  if (request.method === "POST" && pathname === "/api/jasminia-sandbox/v1/probe") {
  ...
  if (request.method === "POST" && pathname === "/api/jasminia-sandbox/v1/leases/acquire") {
    ...
    // after creation: Jasmin.ia never sees the lease ID in that case, so it
  ...
  if (request.method === "POST" && pathname === "/api/jasminia-sandbox/v1/leases/resume") {
  ...
  if (request.method === "POST" && pathname === "/api/jasminia-sandbox/v1/leases/release") {
  ...
  if (request.method === "DELETE" && pathname.startsWith("/api/jasminia-sandbox/v1/leases/")) {
  ...
  if (request.method === "POST" && pathname === "/api/jasminia-sandbox/v1/exec") {
