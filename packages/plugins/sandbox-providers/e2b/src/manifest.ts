...
const PLUGIN_ID = "jasminia.e2b-sandbox-provider";
...
const manifest: JasminiaPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions E2B cloud sandboxes as Jasmin.ia execution environments.",
  author: "Jasmin.ia",
      ...
      configSchema: {
        ...
        properties: {
          ...
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific E2B API key. Paste a key or an existing Jasmin.ia secret reference; saved environments store pasted values as company secrets. Falls back to E2B_API_KEY if omitted.",
          },
          timeoutMs: {
            type: "number",
