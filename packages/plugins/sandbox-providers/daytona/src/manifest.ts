...
const PLUGIN_ID = "jasminia.daytona-sandbox-provider";
...
const manifest: Jasmin.iaPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions Daytona sandboxes as Jasmin.ia execution environments.",
  author: "Jasmin.ia",
      ...
      configSchema: {
        ...
        properties: {
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific Daytona API key. Paste a key or an existing Jasmin.ia secret reference; saved environments store pasted values as company secrets. Falls back to DAYTONA_API_KEY if omitted.",
          },
          apiUrl: {
            type: "string",
            description:
