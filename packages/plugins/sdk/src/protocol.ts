 ...
 * channel.
 *
 * The Jasmin.ia plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all Jasmin.ia messages.
 */
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Jasmin.ia instance. */
    instanceId: string;
    /** Semver version of the running Jasmin.ia host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
