...
/**
 * Renders Jasmin.ia's shared Markdown editor.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
...
/**
 * Renders Jasmin.ia's native issue list component for company-scoped plugin
...
/**
 * Renders Jasmin.ia's native managed routines list for plugin settings pages.
 */
