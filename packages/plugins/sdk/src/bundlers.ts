/**
 * Bundling presets for Jasmin.ia plugins.
 *
 ...
 * to match the Jasmin.ia plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@jasminiaai/plugin-sdk/ui",
    "@jasminiaai/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const esbuildManifest: EsbuildLikeOptions = {
    ...
    target: "node20",
    sourcemap,
    external: ["@jasminiaai/plugin-sdk"],
  };
