...
import type { JasminiaPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@jasminia/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: JasminiaPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@jasminia/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
