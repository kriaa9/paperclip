...
const manifest: Jasmin.iaPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Jasmin.ia plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Jasmin.ia",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Jasmin.ia domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
