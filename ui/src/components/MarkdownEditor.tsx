...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@jasminiaai/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative jasminia-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("jasminia-mdxeditor", !bordered && "jasminia-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "jasminia-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
