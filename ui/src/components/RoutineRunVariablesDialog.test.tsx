...
import type { Agent, ExecutionWorkspace, Project } from "@jasminiaai/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/jasminia/project-1",
      effectiveLocalFolder: "/tmp/jasminia/project-1",
