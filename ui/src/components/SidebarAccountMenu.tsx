...
const DOCS_URL = "https://docs.jasminia.com/";
          ...
          <div className="-mt-8 px-4 pb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 pt-1">
                ...
                {version ? (
                  <p className="mt-1 text-xs text-muted-foreground">Jasmin.ia v{version}</p>
                ) : null}
              </div>
            </div>
            ...
            <div className="mt-4 space-y-1">
              ...
              <MenuAction
                label="Documentation"
                description="Open Jasmin.ia docs in a new tab."
                icon={BookOpen}
                href={DOCS_URL}
                external
