...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "Jasmin.ia" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "Jasmin.ia" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "Jasmin.ia" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "Jasmin.ia" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "Jasmin.ia" },
