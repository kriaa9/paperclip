...
export const DISMISSED_KEY = "jasminia:inbox:dismissed";
export const READ_ITEMS_KEY = "jasminia:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "jasminia:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "jasminia:inbox:issue-columns";
export const INBOX_NESTING_KEY = "jasminia:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "jasminia:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "jasminia:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "jasminia:inbox:collapsed-groups";
