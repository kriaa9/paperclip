 ...
 * `useHostContext` from `@jasminiaai/plugin-sdk/ui`.  Those are type-only
 ...
 * registry on `globalThis.__jasminiaPluginBridge__`), context propagation
...
/**
 * Resolve a plugin-provided Jasmin.ia path to the active company scope.
 *
