 ...
 *
 * This is placed on `globalThis.__jasminiaPluginBridge__` and consumed by
...
declare global {
  ...
  var __jasminiaPluginBridge__: PluginBridgeRegistry | undefined;
}
...
function PluginSdkIssuesList({
  ...
  projectId = null,
  filters,
  viewStateKey = "jasminia:plugin-issues-view",
  initialSearch,
  createIssueLabel,
 ...
 * on `globalThis.__jasminiaPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__jasminiaPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
