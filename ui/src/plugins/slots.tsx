 ...
 *
 * Plugin bundles are built with `external: ["@jasminia/plugin-sdk/ui", "react", "react-dom"]`,
    ...
    case "sdk-ui":
      source = `
        ...
        function missing(name) {
          return function MissingJasminiaSdkUiComponent() {
 ...
 * - `import { ... } from "@jasminia/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@jasminia/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@jasminia/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@jasminia/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@jasminia/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@jasminia/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
