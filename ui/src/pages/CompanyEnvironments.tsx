                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="space-y-1">
                      ...
                      {environment.driver === "ssh" ? (
                        ...
                        <div className="text-xs text-muted-foreground">Runs on this Jasmin.ia host.</div>
                      )}
                    </div>
          ...
          <div className="space-y-3">
            ...
            {environmentForm.driver === "ssh" ? (
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <Field label="Remote workspace path" hint="Absolute path that Jasmin.ia will verify during SSH connection tests.">
                  <input
                    className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                    type="text"
                    placeholder="/Users/jasminia/workspace"
