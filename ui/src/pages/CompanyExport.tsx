...
/**
 * Filter .jasminia.yaml content so it only includes entries whose
...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is an [Agent Company](https://jasminia.com) package.");
  lines.push("");
  ...
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Jasmin.ia](https://jasminia.com) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
...
export function CompanyExport() {
  ...
  // Recompute .jasminia.yaml and README.md content whenever checked files
