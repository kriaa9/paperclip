...
import type { Agent, Issue, IssueTreeControlPreview, IssueTreeHold } from "@jasminiaai/shared";
...
vi.mock("../context/CompanyContext", () => ({
  useCompany: () => ({
    companies: [{ id: "company-1", name: "Jasmin.ia", issuePrefix: "PAP", status: "active" }],
    selectedCompanyId: "company-1",
    selectedCompany: { id: "company-1", name: "Jasmin.ia", issuePrefix: "PAP", status: "active" },
...
describe("IssueDetail", () => {
  ...
  it("forwards composer work mode changes to the issues API", async () => {
    ...
    localStorage.setItem("jasminia:issue-comment-draft:issue-1", "Draft follow-up message");
    ...
    expect(localStorage.getItem("jasminia:issue-comment-draft:issue-1")).toBe("Draft follow-up message");
    expect(container.textContent).toContain("planning-notes.txt");
    localStorage.removeItem("jasminia:issue-comment-draft:issue-1");
  });
