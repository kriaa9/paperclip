...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@jasminiaai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Jasmin.ia file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Jasmin.ia storage.";
