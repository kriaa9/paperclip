...
describe("ImportFromVaultDialog", () => {
  ...
  it("blocks import when a review row collides with an existing Jasmin.ia secret", async () => {
    ...
    expect(document.body.textContent?.toLowerCase()).toContain("a jasminia secret already uses this");
