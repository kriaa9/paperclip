...
import type { PatchInstanceGeneralSettings, BackupRetentionPolicy } from "@jasminiaai/shared";
import {
...
const FEEDBACK_TERMS_URL = import.meta.env.VITE_FEEDBACK_TERMS_URL?.trim() || "https://jasminia.com/tos";
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              ...
              Jasmin.ia Labs. Votes are always saved locally.
            </p>
            {FEEDBACK_TERMS_URL ? (
              <a
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              Sign out of this Jasmin.ia instance. You will be redirected to the login page.
            </p>
          </div>
          <Button
            variant="outline"
