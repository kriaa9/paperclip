...
describe("InviteLandingPage", () => {
  ...
  it("defaults invite auth to account creation and guides existing users back to sign in", async () => {
    ...
    expect(container.textContent).toContain("You've been invited to join Jasmin.ia");
    ...
    expect(localStorage.getItem("jasminia:pending-invite-token")).toBe("pcp_invite_test");
  ...
  it("auto-accepts the invite after account creation and redirects into the company", async () => {
    ...
    expect(localStorage.getItem("jasminia:pending-invite-token")).toBeNull();
