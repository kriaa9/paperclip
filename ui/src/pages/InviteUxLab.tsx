  ...
  return (
    <>
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">You&apos;ve been invited to join Jasmin.ia</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? "Start with a Jasmin.ia account. After that, you'll come right back here to accept the invite for Acme Robotics."
        ...
        <div className="flex min-h-[420px] flex-col justify-center bg-background px-8 py-10">
          <div className="mx-auto w-full max-w-md">
            <div className="mb-8 flex items-center gap-2">
              ...
              <span className="text-sm font-medium">Jasmin.ia</span>
            </div>
            <h3 className="text-xl font-semibold">
              {mode === "sign_in" ? "Sign in to Jasmin.ia" : "Create your Jasmin.ia account"}
            </h3>
      ...
      <Card className="rounded-[28px] shadow-none">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3 rounded-2xl border border-border px-4 py-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  This URL includes the current Jasmin.ia domain returned by the server.
                </div>
              </div>
            ...
            >
              https://jasminia.local/invite/new-token
            </button>
          ...
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description="Create your Jasmin.ia account first. If you already have one, switch to sign in and continue the invite with the same email."
