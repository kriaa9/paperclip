...
const storybookRepoRoot = "~/jasminia";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.jasminia/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.jasminia/worktrees`;
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Jasmin.ia product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    description: "Make Jasmin.ia the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @jasminiaai/ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://jasminia-docs-preview.vercel.app",
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".jasminia/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/jasminiaData.ts`.",
  ].join("\n"),
...
export const storybookSecrets: CompanySecret[] = [
  ...
  },
  {
    ...
    externalRef: "arn:aws:secretsmanager:us-east-1:123456789012:secret:jasminia/prod/aws-deploy-AbCdEf",
    providerConfigId: null,
    providerMetadata: null,
    latestVersion: 2,
...
export const storybookSecretBindings: CompanySecretBinding[] = [
  ...
  },
  {
    ...
    versionSelector: "latest",
    required: true,
    label: "Jasmin.ia App project env",
    createdAt: new Date("2026-03-02T09:00:00.000Z"),
    updatedAt: new Date("2026-03-02T09:00:00.000Z"),
  },
  {
  ...
  providers: [
    {
      ...
      warnings: [] as string[],
      backupGuidance: ["Backup ~/.jasminia/instances/default/secrets/key separately from the database."],
    },
    {
