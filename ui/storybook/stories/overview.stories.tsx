...
function StorybookGuide() {
  return (
    <div className="jasminia-story">
      <main className="jasminia-story__inner space-y-8">
        <section className="jasminia-story__frame overflow-hidden p-6 sm:p-8">
          <div className="flex flex-wrap items-start justify-between gap-6">
            <div className="max-w-3xl">
              <div className="jasminia-story__label flex items-center gap-2">
              ...
              <p className="mt-4 text-sm leading-6 text-muted-foreground sm:text-base">
                This Storybook is organized as a review workspace for Jasmin.ia's operator UI: primitives first,
        ...
        <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {storyGroups.map((group) => {
            ...
            return (
              <Card key={group.title} className="jasminia-story__frame shadow-none">
                <CardHeader>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "The overview story explains the local organization and the coverage contract for Jasmin.ia's Storybook.",
      },
    },
  },
