    ...
    <div className="jasminia-story">
      <main className="jasminia-story__inner space-y-6">
        <section className="jasminia-story__frame p-6">
          <div className="jasminia-story__label">Foundations</div>
          <h1 className="mt-2 text-3xl font-semibold tracking-tight">Primitives and interaction states</h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            A dense pass over the base controls that Jasmin.ia pages use for operational actions, filtering,
        ...
        <Section eyebrow="Inputs" title="Form controls with real Jasmin.ia copy">
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Foundation stories keep base shadcn/Radix primitives visible in every variant and key interaction state used by Jasmin.ia.",
      },
    },
  },
