        ...
        <main className="jasminia-story__inner space-y-6">
          <section className="jasminia-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="jasminia-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="jasminia-story__frame shadow-none">
                  <CardHeader>
      ...
      <div className="jasminia-story">
        <main className="jasminia-story__inner space-y-6">
          <section className="jasminia-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="jasminia-story__label">IssueRunLedger</div>
