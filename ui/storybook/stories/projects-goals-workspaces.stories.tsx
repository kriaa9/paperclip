...
import type { Goal, Project } from "@jasminiaai/shared";
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-border bg-background p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="jasminia-story__label">Goal detail composition</div>
...
function GoalTreeMatrix() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="rounded-lg border border-border bg-background p-4">
        <div className="jasminia-story__label">Selected goal</div>
        {selectedGoal ? (
...
function WorktreeBannerMatrix() {
  setWorktreeMeta("jasminia-worktree-enabled", "true");
  setWorktreeMeta("jasminia-worktree-name", "PAP-1675-projects-goals-workspaces");
  setWorktreeMeta("jasminia-worktree-color", "#0f766e");
  setWorktreeMeta("jasminia-worktree-text-color", "#ecfeff");
        ...
        <main className="jasminia-story__inner space-y-6">
          <section className="jasminia-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="jasminia-story__label">Projects, goals, and workspaces</div>
