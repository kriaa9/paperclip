...
import { createIssue, storybookAgents } from "../fixtures/jasminiaData";
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Jasmin.ia secret provider.",
    },
    concurrency: {
      type: "integer",
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Jasmin.ia" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    defaultRef: "master",
    repoName: "jasminia",
    localFolder: "/Users/dotta/jasminia",
    managedFolder: "jasminia",
    effectiveLocalFolder: "/Users/dotta/jasminia",
    origin: "local_folder",
  },
  workspaces: [],
    ...
    <StoryShell>
      <section className="jasminia-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="jasminia-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Jasmin.ia form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Jasmin.ia form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
