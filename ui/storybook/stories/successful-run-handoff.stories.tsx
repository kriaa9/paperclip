  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4">
      ...
      <SuccessfulRunHandoffCommentCallout
        text={[
          "Jasmin.ia exhausted the bounded successful-run handoff correction for this issue, but it still has no valid issue disposition.",
          "",
...
const meta = {
  title: "Jasmin.ia/Successful Run Handoff",
