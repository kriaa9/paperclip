...
import type { CompanySecret, EnvBinding } from "@jasminiaai/shared";
...
import { storybookCompanies, storybookSecrets } from "../fixtures/jasminiaData";

const COMPANY_ID = "company-storybook";

// Seed localStorage before CompanyContext mounts so its `useState` initializer reads the right id.
if (typeof window !== "undefined") {
  window.localStorage.setItem("jasminia.selectedCompanyId", COMPANY_ID);
}
