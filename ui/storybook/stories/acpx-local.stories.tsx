...
import type { AdapterConfigSchema, CreateConfigValues } from "@jasminiaai/adapter-utils";
import { parseAcpxStdoutLine } from "@jasminiaai/adapter-acpx-local/ui";
import type {
  Agent,
  AgentSkillSnapshot,
...
const acpxLocalConfigSchema: AdapterConfigSchema = {
  fields: [
    ...
    },
    {
      ...
      hint: "Fallback if the ACP agent asks for input outside an interactive session. Jasmin.ia still auto-approves permissions by default.",
    },
    {
      key: "cwd",
      label: "Working directory",
      type: "text",
      hint: "Absolute fallback directory. Jasmin.ia execution workspaces can override this at runtime.",
    },
    {
      key: "stateDir",
      label: "State directory",
      type: "text",
      hint: "Optional ACPX session state directory. Defaults to Jasmin.ia-managed company/agent scoped storage.",
    },
    {
      key: "fastMode",
...
function installAcpxSchemaMock(): void {
  ...
  win.__jasminiaStorybookAdapterSchemas = {
    ...(win.__jasminiaStorybookAdapterSchemas ?? {}),
...
const acpxSkillsCompanyLibrary: CompanySkillListItem[] = [
  {
    ...
    name: "Jasmin.ia",
    description:
      "Coordination skill: heartbeats, checkout, comments, and routine API patterns for Jasmin.ia agents.",
    sourceType: "local_path",
    sourceLocator: "skills/jasminia",
    sourceRef: null,
    ...
    editable: false,
    editableReason: "Required by Jasmin.ia",
    sourceLabel: "Jasmin.ia",
    sourceBadge: "jasminia",
    sourcePath: "skills/jasminia",
  },
  {
    ...
    name: "Design guide",
    description:
      "Jasmin.ia UI design system reference: tokens, typography, status colors, and reusable component patterns.",
    sourceType: "local_path",
...
function buildAcpxClaudeSnapshot(): AgentSkillSnapshot {
  return {
    ...
    supported: true,
    mode: "ephemeral",
    desiredSkills: ["jasminia", "design-guide"],
    warnings: [],
    entries: [
      {
        key: "jasminia",
        ...
        managed: true,
        required: true,
        requiredReason: "Jasmin.ia coordination skill is mandatory for control-plane agents.",
        state: "configured",
  ...
  return {
    ...
    entries: [
      ...
      },
      {
        ...
        targetPath: null,
        detail:
          "Desired state is stored in Jasmin.ia only; custom ACP commands need an explicit skill integration contract before runtime sync is available.",
      },
      {
        key: "mobile-app-qa",
        runtimeName: "mobile-app-qa",
...
function AcpxClaudeSkillsStory() {
  ...
  return (
    <StoryFrame
      ...
      subtitle="Runtime-synced state. Selected skills are mounted into the next ACPX Claude session via the Jasmin.ia skills directory."
    >
...
function AcpxCustomSkillsStory() {
  ...
  return (
    <StoryFrame
      ...
      subtitle="Unsupported runtime sync. Desired skills are tracked in Jasmin.ia only until a custom ACP command declares a skill integration contract."
    >
