...
import type { CompanySearchResult, CompanySearchResponse } from "@jasminiaai/shared";
...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/jasminiaData";
...
function SearchStories() {
  return (
    <div className="jasminia-story">
      <main className="jasminia-story__inner max-w-[1320px] space-y-6">
        <section className="jasminia-story__frame p-6">
          <div className="jasminia-story__label">Search</div>
        ...
        <section className="jasminia-story__frame overflow-hidden">
          <div className="jasminia-story__title-block">
            <div className="jasminia-story__label">/search</div>
        ...
        <section className="jasminia-story__frame overflow-hidden p-4">
          <div className="jasminia-story__title-block">
            <div className="jasminia-story__label">Match-source chips</div>
        ...
        <section className="jasminia-story__frame overflow-hidden p-4">
          <div className="jasminia-story__title-block">
            <div className="jasminia-story__label">Cmd+K palette</div>
        ...
        <section className="jasminia-story__frame overflow-hidden p-4">
          <div className="jasminia-story__title-block">
            <div className="jasminia-story__label">Search result row</div>
