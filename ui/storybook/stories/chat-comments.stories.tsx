...
import type { Agent, FeedbackVote, IssueComment } from "@jasminiaai/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/jasminiaData";
...
function Section({
  ...
  return (
    <section className="jasminia-story__frame overflow-hidden">
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-border px-5 py-4">
        <div>
          <div className="jasminia-story__label">{eyebrow}</div>
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Jasmin.ia work: checkout, comments, linked runs, and review feedback.",
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <div className="space-y-5">
          ...
          <ScenarioCard
            ...
            description="Issue is in planning mode. The composer turns amber and surfaces a Planning chip next to the jasminia — clicking it stages a Standard submission without immediately changing the issue mode."
          >
            <IssueChatThread
              comments={[]}
              timelineEvents={[]}
...
function IssueThreadNoticeReview() {
  return (
    <div className="jasminia-story">
      <main className="jasminia-story__inner max-w-4xl">
...
function ChatCommentsStories() {
  return (
    <div className="jasminia-story">
      <main className="jasminia-story__inner space-y-6">
        <section className="jasminia-story__frame p-6">
          <div className="jasminia-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Jasmin.ia operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="jasminia-story">
      <main className="jasminia-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
