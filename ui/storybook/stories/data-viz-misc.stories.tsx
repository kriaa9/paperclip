...
function CompanyPatternIconMatrix() {
  const companies = [
    { name: "Jasmin.ia Storybook", color: "#0f766e" },
...
function AsciiArtAnimationDemo({ loading = false }: { loading?: boolean }) {
  return (
    <StoryShell>
      <Section eyebrow="AsciiArtAnimation" title={loading ? "Loading art surface" : "Animated ASCII jasminia field"}>
