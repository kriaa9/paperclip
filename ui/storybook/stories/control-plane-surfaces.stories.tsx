      ...
      <main className="jasminia-story__inner space-y-6">
        <section className="jasminia-story__frame p-6">
          <div className="flex flex-wrap items-start justify-between gap-5">
            <div>
              <div className="jasminia-story__label">Product surfaces</div>
              <h1 className="mt-2 text-3xl font-semibold tracking-tight">Control-plane boards and cards</h1>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
                Jasmin.ia's common board surfaces are deliberately dense: task rows, approvals, budget policy cards,
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Product-surface stories exercise the board UI components that carry Jasmin.ia's task, approval, budget, activity, and agent governance workflows.",
      },
    },
  },
