...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@jasminiaai/shared";
import type {
...
import { createIssue } from "../fixtures/jasminiaData";
    ...
    <div className="jasminia-story">
      <main className="jasminia-story__inner space-y-6">
        <section className="jasminia-story__frame p-6">
          <div className="jasminia-story__label">Language</div>
