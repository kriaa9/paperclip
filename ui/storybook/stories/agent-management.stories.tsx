...
import { storybookAgents, storybookIssues } from "../fixtures/jasminiaData";
...
const agentManagementAgents: Agent[] = [
  agentWith({
    ...
    adapterConfig: {
      ...
      env: {
        ...
        JASMINIA_TRACE: { type: "plain", value: "storybook" },
  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      payloadTemplateJson: JSON.stringify({ channel: "jasminia-storybook", priority: "normal" }, null, 2),
      env: {
        ...
        <main className="jasminia-story__inner space-y-6">
          <section className="jasminia-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="jasminia-story__label">Agent management</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended Jasmin.ia fixtures.",
      },
    },
  },
