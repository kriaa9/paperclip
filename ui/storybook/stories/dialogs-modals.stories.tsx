...
const SELECTED_COMPANY_STORAGE_KEY = "jasminia.selectedCompanyId";
const ISSUE_DRAFT_STORAGE_KEY = "jasminia:issue-draft";

const storybookGoals: Goal[] = [
  {
    id: "goal-company",
    companyId: COMPANY_ID,
    title: "Build Jasmin.ia",
...
const closeReadinessReady: ExecutionWorkspaceCloseReadiness = {
  ...
  plannedActions: [
    ...
    },
    {
      ...
      command: "git worktree remove .jasminia/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
    },
    {
      kind: "archive_record",
  ...
  git: {
    repoRoot: "/Users/dotta/jasminia",
    workspacePath: "/Users/dotta/jasminia/.jasminia/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="jasminia-story">
      <main className="jasminia-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
function ProjectDialogOpener({ populated }: { populated?: boolean }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      fillFirstField("input[placeholder='https://github.com/org/repo']", "#
      fillFirstField("input[placeholder='/absolute/path/to/workspace']", "/Users/dotta/jasminia/ui");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Open-state stories for Jasmin.ia creation dialogs, workspace confirmations, document diffing, image attachments, and path helper modals.",
      },
    },
  },
} satisfies Meta;
