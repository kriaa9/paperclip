...
Eval framework for testing Jasmin.ia agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Jasmin.ia heartbeat skill:
