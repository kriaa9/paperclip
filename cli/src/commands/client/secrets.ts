...
export function registerSecretCommands(program: Command): void {
  ...
  addCommonClientOptions(
    secrets
      .command("create")
      .description("Create a Jasmin.ia-managed secret")
      .requiredOption("-C, --company-id <id>", "Company ID")
  ...
  addCommonClientOptions(
    secrets
      .command("link")
      .description("Link an external provider-owned secret without storing its value in Jasmin.ia")
      .requiredOption("-C, --company-id <id>", "Company ID")
      .requiredOption("--name <name>", "Secret display name")
  ...
  addCommonClientOptions(
    secrets
      .command("doctor")
      .description("Run secret provider health checks through the Jasmin.ia API")
      .requiredOption("-C, --company-id <id>", "Company ID")
