  ...
  return {
    ...
    create: async (
      ...
      input: {
        ...
        value?: string | null;
        key?: string | null;
        managedMode?: "jasminia_managed" | "external_reference";
        description?: string | null;
      ...
      const managedMode = input.managedMode ?? "jasminia_managed";
      ...
      if (managedMode === "jasminia_managed" && input.externalRef?.trim()) {
        throw unprocessable("Managed secrets cannot override externalRef");
      }
      if (managedMode === "jasminia_managed" && !input.value?.trim()) {
      ...
      try {
        ...
        if (managedMode === "jasminia_managed") {
    ...
    update: async (
      ...
      if (deleting && secret.managedMode === "jasminia_managed") {
      ...
      if (
        secret.managedMode === "jasminia_managed" &&
        patch.providerConfigId !== undefined &&
        patch.providerConfigId !== secret.providerConfigId
      ) {
        throw unprocessable(
