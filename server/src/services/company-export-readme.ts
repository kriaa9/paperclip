 ...
 */
import type { CompanyPortabilityManifest } from "@jasminiaai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Jasmin.ia](https://jasminia.com)");
  lines.push("");
