/**
 * PluginEventBus — typed in-process event bus for the Jasmin.ia plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@jasminiaai/shared";
import type { PluginEvent, EventFilter } from "@jasminiaai/plugin-sdk";
