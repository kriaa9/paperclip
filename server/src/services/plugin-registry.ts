...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: Jasmin.iaPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a Jasmin.ia object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
