...
describe("shouldSilenceHttpSuccessLog", () => {
  ...
  it("silences successful static asset requests", () => {
    ...
    expect(shouldSilenceHttpSuccessLog("GET", "/@fs/Users/dotta/jasminia/ui/src/main.tsx", 200)).toBe(true);
  ...
  it("keeps failing requests visible", () => {
    ...
    expect(shouldSilenceHttpSuccessLog("GET", "/@fs/Users/dotta/jasminia/ui/src/main.tsx", 404)).toBe(false);
  });
});
