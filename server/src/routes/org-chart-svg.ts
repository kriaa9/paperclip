/**
 * Server-side SVG renderer for Jasmin.ia org charts.
...
// Jasmin.ia logo: scaled icon (~16px) + wordmark (13px), vertically centered
const JASMINIA_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">Jasmin.ia</text>
</g>`;
