...
- Fire externally: `POST /api/routine-triggers/public/{publicId}/fire`
  ...
  - HMAC: `X-Jasmin.ia-Signature` + `X-Jasmin.ia-Timestamp` headers
...
Use the generic API endpoint tables in `skills/jasminia/references/api-reference.md` when you need a full cross-domain reference. Use this file when you need routine-specific behaviour, payload shape, or policy details.
