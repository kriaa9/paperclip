...
- [ ] The first paragraph points at the Jasmin.ia skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Jasmin.ia execution contract verbatim:
...
- [ ] Adapter config matches this Jasmin.ia instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
