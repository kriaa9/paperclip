---
name: jasminia-create-plugin
description: >
  Create new Jasmin.ia plugins with the current alpha SDK/runtime. Use when
...
# Create a Jasmin.ia Plugin

Use this skill when the task is to create, scaffold, or document a Jasmin.ia plugin.
...
- is installed into Jasmin.ia from an absolute local path during development
