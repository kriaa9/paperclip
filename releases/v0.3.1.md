...
- **Tools for Worktree workflow for developers** — New `jasminia worktree:make` command provisions isolated development instances with their own database, secrets, favicon branding, and git hooks. Worktrees support minimal seed mode, start-point selection, and automatic workspace rebinding. ([#496](# [#530](# [#545](#
...
Both are additive (new table and new columns) — no existing data is modified. Standard `jasminia` startup will apply them automatically.
