...
- **Improved CLI API connection errors** — Better error messages when the CLI cannot reach the Jasmin.ia API.
...
- **Dev restart tracking** — `.jasminia` and test-only paths are now ignored in dev restart detection.
